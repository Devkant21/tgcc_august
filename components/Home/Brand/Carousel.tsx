...
const images = [
    ...
    { src: "/image/TGCC_Windmills.jpg", alt: "Image 3", title: "WINDMILL", desc: "The tour will round-off/conclude with an authentic Indian meal and experimental Indian brews and spirits at Bangalore’s famed Windmills Brewery." },
];
