        ...
        <section className="ageConsentSection">
            <div className='wrapContainer UniformRegular space-y-6'>
                ...
                <div className="content">
                    ...
                    <p className='pt-10 ConsentUniformMedium'>Welcome to a journey unlike any other, but before we sail on to discover rare Indian spirits, please if you are 25 or older.</p>
                </div>
